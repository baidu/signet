...
define("zrender/tool/env", [], function() {
		...
		if (t instanceof Object)
			for (var s in t)
				if (t.hasOwnProperty(s))
					if (t[s] instanceof Object && r && e[s]) i(e[s], t[s], n, r);
		...
		r = function() {
			function t(t, n, i, s, o) {
				if (n.hasOwnProperty(i))
					if (o && typeof t[i] == "object" && e[Object.prototype.toString.call(t[i])] != 1) r(t[i], n[i], {
						overwrite: s,
						recursive: o
					});
	...
	function f(e, t, n) {
		...
		for (var c = 0; c < r; c++) {
			var h = e[c],
				f, l;
			if (n) f = e[c === 0 ? r - 1 : c - 1], l = e[(c + 1) % r];
			else {
				if (c === 0 || c === r - 1) {
					s.push(e[c]);
					continue
	...
	function a(e, t, n, r, i) {
		var s = e.length;
		if (i == 1)
			for (var o = 0; o < s; o++) r[o] = u(e[o], t[o], n);
		else {
			var a = e[0].length;
			for (var o = 0; o < s; o++)
				for (var f = 0; f < a; f++) r[o][f] = u(e[o][f], t[o][f], n)
		}
	}
	...
	function l(e, t, n, r, i, s, o, u, a) {
		var f = e.length;
		if (a == 1)
			for (var l = 0; l < f; l++) u[l] = c(e[l], t[l], n[l], r[l], i, s, o);
		else {
			var h = e[0].length;
			for (var l = 0; l < f; l++)
				for (var p = 0; p < h; p++) u[l][p] = c(e[l][p], t[l][p], n[l][p], r[l][p], i, s, o)
		}
	}
	...
	function c(n, r, i) {
		...
		d.highlightStyle.color = p.color || u.getLinearGradient(p.x, p.y, p.x + p.width, p.y + p.height, [
			[0, "#ff6400"],
			[.5, "#ffe100"],
			[1, "#b1ff00"]
		]);
	...
	function m(n, r, i) {
		...
		for (var k = 0; k < 16; k++) x.push({
			...
			_color: u.getLinearGradient(m + y * c.cos(C, !0), g - y * c.sin(C, !0), m + y * c.cos(C - N, !0), g - y * c.sin(C - N, !0), [
				[0, T[k * 2]],
				[1, T[k * 2 + 1]]
			])
		}), C -= N;
	...
	function o(n, i, s) {
		...
		y.start(), o.getId = function() {
			...
			if (s) {
				...
				return typeof s.__aniCount == "undefined" && (s.__aniCount = 0), s.__aniCount === 0 && g.push(s), s.__aniCount++, y.animate(o, {
					loop: i
				}).done(function() {
					s.__aniCount--;
					if (s.__aniCount === 0) {
	...
	function a(n, i, s) {
		...
		function C(e) {
			return B() && H(), S(), A(), i.iterShape(T({
				...
				normal: "up"
			}), i.clearChangedZlevel(), typeof e == "function" && e(), u
		}
	...
	function f(t, n, r, i) {
		...
		function O(e) {
			...
			c = J(e), E = x, S = T, x = f(c), T = l(c), I(), h = !1, n.iterShape($, {
				normal: "down"
			});
			if (!h) {
		...
		buildLinePath: function(e, t) {
			...
			if (!t.lineType || t.lineType == "solid") {
				...
				if (t.smooth !== "spline") {
					...
					for (var i = 0; i < r - 1; i += 2) e.moveTo(n[i][0], n[i][1]), e.lineTo(n[i + 1][0], n[i + 1][1])
		},
	...
	function t(t, n) {
		...
		function b(e, n, r, i, s) {
			...
			if (a.type == t.CHART_TYPE_FORCE || a.type == t.CHART_TYPE_CHORD)
				for (var p = 0, d = v.length; p < d; p++) v[p].id = a.zr.newShapeId(a.type), a.zr.addShape(v[p])
		}

		function w(e, n, r, i, s) {
			var u = a.getZlevelBase(),
				f, l, c = o.clone(e.markLine);
			...
			if (a.type == t.CHART_TYPE_FORCE || a.type == t.CHART_TYPE_CHORD)
				for (var h = 0, p = d.length; h < p; h++) d[h].id = a.zr.newShapeId(a.type), a.zr.addShape(d[h])
		}
		...
		function E(e, n, i, s) {
			...
			for (var E = 0, S = f.length; E < S; E++) {
				...
				f[E].tooltip = f[E].tooltip || {
					trigger: "item"
				}, f[E].name = typeof f[E].name != "undefined" ? f[E].name : "", f[E].value = typeof f[E].value != "undefined" ? f[E].value : "", l = T(i, n, f[E], E, f[E].name, a.parsePercent(f[E].x, b), a.parsePercent(f[E].y, w), "pin", p, "rgba(0,0,0,0)", "horizontal"), y = a.deepMerge([f[E], i], "effect"), y.show && (l.effect = y), r.pack(l, e, n, f[E], 0, f[E].name), u.push(l)
			}
			return u
		}
		...
		function A(e, t) {
			...
			for (var s = 0, o = a.shapeList.length; s < o; s++) {
				...
				r = a.shapeList[s]._x || 0, i = a.shapeList[s]._y || 0, a.shapeList[s]._mark == "point" ? (n.modShape(a.shapeList[s].id, {
					scale: [0, 0, r, i]
					...
					style: {
						pointList: [
							[a.shapeList[s].style.xStart, a.shapeList[s].style.yStart],
							[a.shapeList[s].style.xStart, a.shapeList[s].style.yStart]
						]
					}
				}, !0), n.animate(a.shapeList[s].id, "style").when(e, {
		...
		function O() {
			...
			for (var o = 0, u = a.shapeList.length; o < u; o++) {
				...
				if (shape._mark === "point") c.style.x = shape.style.x - h, c.style.y = shape.style.y - h, p = (s.period + Math.random() * 10) * 100;
				...
				if (shape._mark === "point") {
					...
					if (!shape.style.smooth) n.animate(c.id, "style", !0).when(p, {
						x: shape._x - h,
						y: shape._y - h
					}).start();
					else {
	...
	function t(t, n, r) {
		...
		function w(e) {
			...
			u.style.color == "#fff" && (u.style.color = e.style.strokeColor), a.setCalculable(u), u.dragEnableTime = 0, o.pack(u, {
				name: i
			}, -1, n, -1, t), a.shapeList.push(u), r.addShape(u)
		}
	...
	function t(t, n, r, i, s, o) {
		...
		function C() {
			...
			if (e)
				for (var t = 0, n = v.length; t < n; t++) typeof e == "function" ? m.push(e(v[t])) : typeof e == "string" && m.push(e.replace("{value}", v[t]));
			else
				for (var t = 0, n = v.length; t < n; t++) m.push(f.numAddCommas(v[t]))
		}
	...
	function t(t, n, r, i, s) {
		...
		function I(e, r) {
			...
			B(), r.dragOut = !0, r.dragIn = !0, !w && !f.realtime && n.dispatch(t.EVENT.DATA_ZOOM, null, {
				zoom: p
			...
			if (h.orient == "horizontal") {
				...
				for (var b = 0; b < t; b++) {
					...
					dataTextStyle = a.merge(e[b].textStyle || {}, o, {
						overwrite: !1
					}), g += r + f.getTextWidth(e[b].name || e[b], e[b].textStyle ? c.getFont(a.merge(e[b].textStyle || {}, o, {
						overwrite: !1
					})) : u) + n
				}
				p = Math.max(p, s), g -= n, g > v ? (l = v, p += s + n) : l = Math.max(l, g)
			} else {
				for (var b = 0; b < t; b++) y = Math.max(y, f.getTextWidth(e[b].name || e[b], e[b].textStyle ? c.getFont(a.merge(e[b].textStyle || {}, o, {
					overwrite: !1
				})) : u));
				y += r, l = y;
				for (var b = 0; b < t; b++) {
		...
		function A(e) {
			if (e) {
				...
				if (s.legend.selected)
					for (var t in s.legend.selected) g[t] = s.legend.selected[t]
			}
	...
	function t(t, n, r, i) {
		...
		function L() {
			var e = c.x,
				...
				p, v, m, g, y, b, w, E;
			a.orient == "horizontal" ? a.y != "bottom" ? (p = [
				[e, t],
				[e, t + r + s],
				[e - s, t + r + s],
				[e - 1, t + r],
				[e - 1, t]
			], v = e - l / 2 - s, m = t + r + s / 2 + 2, g = {
				x: e - l - s,
				y: t + r,
				width: l + s,
				height: s
		...
		function M() {
			...
			if (a.orient == "horizontal") {
				...
				var d;
				if (a.text || a.splitNumber <= 0 || a.calculable) l = (a.splitNumber <= 0 || a.calculable ? s * 10 + n : t * (s + n)) + (a.text && typeof a.text[0] != "undefined" ? b + h : 0) + (a.text && typeof a.text[1] != "undefined" ? b + h : 0), d = Math.max(o.getTextWidth(a.text && a.text[0] || "", c), o.getTextWidth(a.text && a.text[1] || "", c)), f = Math.max(i, d);
				else {
					l = (s + n) * t, i += 5, d = 0;
		...
		function X(e) {
			...
			if (a.calculable)
				if (e > w * g.start + a.min || e < w * g.end + a.min) return null;
	...
	function t(t, n, r, i, s, o) {
		...
		function G(e, t) {
			...
			if (r.length > 0) {
				...
				if (typeof o == "function") H = "axis:" + t, N.innerHTML = o(v, H, nt);
		...
		function Y() {
			...
			if (typeof h == "function") H = (e.name || "") + ":" + a.get(D, "dataIndex"), N.innerHTML = h([e.name || "", o, u, f, l], H, nt);
			else if (typeof h == "string") H = NaN, h = h.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), h = h.replace("{a0}", vt(e.name || "")).replace("{b0}", vt(o)).replace("{c0}", u instanceof Array ? u : g.numAddCommas(u)), h = h.replace("{d}", "{d0}").replace("{d0}", f || ""), h = h.replace("{e}", "{e0}").replace("{e0}", a.get(D, "special2") || ""), N.innerHTML = h;
			else {
				H = NaN;
				if (e.type == t.CHART_TYPE_SCATTER) N.innerHTML = (typeof e.name != "undefined" ? vt(e.name) + "<br/>" : "") + (o === "" ? "" : vt(o) + " : ") + u + (typeof f == "undefined" ? "" : " (" + f + ")");
					...
					if (typeof l == "undefined") N.innerHTML = vt(o) + " (" + g.numAddCommas(u) + ")";
					else {
						var b = vt(o),
							w = vt(f);
		...
		function et(e) {
			...
			var r = e.target,
				s = c.getX(e.event),
				o = c.getY(e.event);
			if (!r) D = !1, P = e.event, P._target = P.target || P.toElement, P.zrenderX = s, P.zrenderY = o, L && w && h.isInside(m, w.getArea(), s, o) ? M = setTimeout(V, _) : L && x && x.isInside([s, o]) != -1 ? M = setTimeout(V, _) : (!P.connectTrigger && n.dispatch(t.EVENT.TOOLTIP_OUT_GRID, P), A = setTimeout(z, O));
			else {
		...
		var y = g.getZlevelBase(),
			...
			k, L, A, O, M, _, D, P, H, B = r.getHeight(),
			j = r.getWidth(),
			F = !1,
			I = 0,
			q = {
	...
	function t(t, n, r, i, s) {
		...
		function X(e) {
			if (k) k = !1, h.shapeList.push(L), Y(b.markUndo), Y(b.markClear), r.addShape(L), r.refresh();
			else if (C) {
				k = !0;
		...
		function Q() {
			O = !1, A && (A = !1, b.dataZoom && r.modShape(b.dataZoom.id, {
				style: {
		...
		function nt(e) {
			...
			return v[r] ? v[r] = !1 : (v[r] = !0, r == t.CHART_TYPE_LINE ? v[t.CHART_TYPE_BAR] = !1 : r == t.CHART_TYPE_BAR && (v[t.CHART_TYPE_LINE] = !1), r == P ? v[H] = !1 : r == H && (v[P] = !1)), n.dispatch(t.EVENT.MAGIC_TYPE_CHANGED, e.event, {
				magicType: v
			}), !0
		}

		function rt(e) {
			K(), v = e, !g && n.dispatch(t.EVENT.MAGIC_TYPE_CHANGED, null, {
				magicType: v
			})
		}
		...
		function ot() {
			...
			if (v[t.CHART_TYPE_LINE] || v[t.CHART_TYPE_BAR]) {
				...
				for (var r = 0, i = l.series.length; r < i; r++) m[l.series[r].type] && (l.series[r].type = l.series[r].__type, l.series[r].itemStyle = l.series[r].__itemStyle, e = l.xAxis instanceof Array ? l.xAxis[l.series[r].xAxisIndex || 0] : l.xAxis, e && (e.type || "category") == "category" && (e.boundaryGap = e.__boundaryGap), e = l.yAxis instanceof Array ? l.yAxis[l.series[r].yAxisIndex || 0] : l.yAxis, e && e.type == "category" && (e.boundaryGap = e.__boundaryGap)); if (v[P] || v[H])
				for (var r = 0, i = l.series.length; r < i; r++) v[P] ? l.series[r].stack = "_ECHARTS_STACK_KENER_2014_" : v[H] && (l.series[r].stack = null);
			else
				for (var r = 0, i = l.series.length; r < i; r++) l.series[r].stack = l.series[r].__stack;
			return l
		}
		...
		function T(e) {
			...
			for (n = 0, o = h.length; n < o; n++) {
				...
				if (h[n].type == t.CHART_TYPE_SCATTER)
					for (var r = 0, s = h[n].data.length; r < s; r++) l = e[f], c = l.replace(" ", "").split(","), typeof h[n].data[r].value != "undefined" ? h[n].data[r].value = c : h[n].data[r] = c, f++;
				else {
					l = e[f].split(",");
	...
	function t(t, n, r, i, s) {
		...
		function v(e) {
			var t = l[e],
				...
				c = t.__ecIndicator = [],
				p;
			for (var d = 0; d < i; d++) p = u.polar2cartesian(a, s * Math.PI / 180 + o * d), c.push({
				vector: [p[1], -p[0]]
			})
		}
		...
		function g(e) {
			var t = l[e],
				n = f.deepQuery(h, "indicator"),
				r = t.__ecIndicator,
				s, o, u, c, p = f.deepQuery(h, "splitNumber"),
				d = N(e),
				o, v, m, g, y, b = f.deepQuery(h, "precision");
		...
		function O(e, t, n, r, i, s, o) {
			...
			e.length == 1 && (a = 0);
			if (e.length != 1)
				for (var g = 0; g < e.length; g++) f = e[g].value[t], m(f);
			else {
				v = e[0];
	...
	function u(t) {
		...
		function Y(t, n, r, s, o) {
			...
			for (var E = 0, S = v.length; E < S; E++) {
				...
				if (h.series[t]) {
					...
					if (typeof o != "undefined" && h.series[t].type == i.CHART_TYPE_PIE && c.legend && c.legend.data) f.legend.data = c.legend.data, r ? (h.legend.data.unshift(o), c.legend.data.unshift(o)) : (h.legend.data.push(o), c.legend.data.push(o)), s || (w = l.indexOf(c.legend.data, n.name), w != -1 && (h.legend.data.splice(w, 1), c.legend.data.splice(w, 1))), g[o] = !0;
		...
		function ut(e) {
			...
			v || (v = {});
			if (e instanceof Array)
				for (var t = 0, n = e.length; t < n; t++) v[e[t].id] = e[t];
			else v[e.id] = e;
			return a
		}
		...
		function at(e) {
			if (!e || !v) return a;
			if (e instanceof Array)
				for (var t = 0, n = e.length; t < n; t++) delete v[e[t].id];
			else delete v[e.id];
		...
		function g(e) {
			...
			while (i--) {
				...
				for (var s = 0, o = r.length; s < o; s++)
					if (r[s].type == "max" || r[s].type == "min" || r[s].type == "average") return !0
			}
			return !1
		}
		...
		function C() {
			...
			for (var u = 0, a = f.shapeList.length; u < a; u++)
				if (f.shapeList[u]._main) {
					...
					o = l[f.shapeList[u]._seriesIndex], n = f.shapeList[u]._x || 0, s = f.shapeList[u]._y || 0, r.modShape(f.shapeList[u].id, {
						scale: [0, 0, n, s]
	...
	function t(t, n, r, i, s) {
		...
		function E(e) {
			...
			for (var n = 0, i = f.shapeList.length; n < i; n++) {
				...
				if (t[p] && !t[p][3] && f.shapeList[n].shape == "candle") {
					...
					u = s.xAxis.getAxis(h.xAxisIndex || 0).getGap(), o = t[p][2] ? u : -u, c = 0, r.animate(f.shapeList[n].id, "").when(500, {
						position: [o, c]
					}).start()
				}
			}
		...
		function S() {
			var e = f.query(i, "animationDuration"),
				t = f.query(i, "animationEasing"),
				n, s, o;
			for (var u = 0, a = f.shapeList.length; u < a; u++) f.shapeList[u].shape == "candle" && (o = l[f.shapeList[u]._seriesIndex], n = f.shapeList[u].style.x, s = f.shapeList[u].style.y[0], r.modShape(f.shapeList[u].id, {
				scale: [1, 0, n, s]
			}, !0), r.animate(f.shapeList[u].id, "").when(f.query(o, "animationDuration") || e, {
				scale: [1, 1, n, s]
			}).start(f.query(o, "animationEasing") || t));
	...
	function t(t, n, r, i, s) {
		...
		function N(t, n) {
			...
			if (f == -1) h = {
				value: a.get(o, "value"),
				name: a.get(o, "name")
			}, c[u].data.push(h), p && p.add(h.name, o.style.color || o.style.strokeColor);
			else {
		...
		function L() {
			var e = l.query(i, "animationDuration"),
				...
				n, o, u, f, h, p = s.polar,
				d, v, m, g;
			for (var y = 0, b = l.shapeList.length; y < b; y++) l.shapeList[y].shape == "polygon" && (v = l.shapeList[y], o = a.get(v, "seriesIndex"), n = a.get(v, "dataIndex"), f = c[o], u = f.data[n], h = l.deepQuery([u, f, i], "polarIndex"), d = p.getCenter(h), m = d[0], g = d[1], r.modShape(l.shapeList[y].id, {
				scale: [.1, .1, m, g]
	...
	function n(n, r, i, s, o) {
		...
		function X(e) {
			...
			if (d) v = d.getColor, m = d.isSelected;
			else {
				var t = {},
					n = {},
					r = 0;
	...
	function r(r, o, u, a, f) {
		...
		function et(e, t, r) {
			...
			for (var a = 0; a < o; a++) {
				...
				h.pack(k, {
					name: _
				}, 0, f, v.indexOf(A, f), f.name || "", f.value), u.addShape(k)
			}
		}
		...
		function tt(e, t) {
			...
			for (var r = 0; r < n; r++) {
				...
				v.merge(s.style, k), v.merge(s.highlightStyle, L), typeof i.itemStyle != "undefined" && (i.itemStyle.normal && v.merge(s.style, i.itemStyle.normal, {
					overwrite: !0
				}), i.itemStyle.emphasis && v.merge(s.highlightStyle, i.itemStyle.emphasis, {
					overwrite: !0
				})), x.push(s), b.shapeList.push(s);
				var o = M[i.source],
					a = M[i.target],
					i = O[i.rawIndex];
				h.pack(s, E, 0, {
	...
	function t(t, r, i, s, o) {
		...
		function y(e, t) {
			...
			for (var u = 0, a = t.length; u < a; u++) l.buildMark(c[t[u]], t[u], o, {
				xMarkMap: s
			})
		}
		...
		function w(e, t, n) {
			...
			for (var k = 0, L = t.length; k < L; k++)
				for (var A = 0, O = t[k].length; A < O; A++) r = t[k][A], n[r].counter > 0 && (n[r].average = (n[r].sum / n[r].counter).toFixed(2) - 0), v = o.yAxis.getAxis(c[r].yAxisIndex || 0).getCoord(n[r].average), n[r].averageLine = [
					[o.grid.getX(), v],
					[o.grid.getXend(), v]
				], n[r].minLine = [
					[o.grid.getX(), n[r].minY],
					[o.grid.getXend(), n[r].minY]
				], n[r].maxLine = [
		...
		function E(e, t, n) {
			...
			for (var _ in w) w[_].length > 0 && (p[_] = p[_] || [], p[_].push(w[_]), w[_] = []);
			for (var k = 0, L = t.length; k < L; k++)
				for (var A = 0, O = t[k].length; A < O; A++) r = t[k][A], n[r].counter > 0 && (n[r].average = (n[r].sum / n[r].counter).toFixed(2) - 0), d = o.xAxis.getAxis(c[r].xAxisIndex || 0).getCoord(n[r].average), n[r].averageLine = [
					[d, o.grid.getYend()],
					[d, o.grid.getY()]
				], n[r].minLine = [
					[n[r].minX, o.grid.getYend()],
					[n[r].minX, o.grid.getY()]
				], n[r].maxLine = [
					...
					for (var E = 0, S = y.length; E < S; E++) {
						...
						l.shapeList.push({
							...
							style: {
								miterLimit: i,
								pointList: b.concat([
									[b[b.length - 1][4], b[b.length - 1][5] - 2],
									[b[0][4], b[0][5] - 2]
								]),
								brushType: "fill",
								smooth: x(m.smooth),
		...
		function M() {
			var e = l.query(s, "animationDuration"),
				...
				n, r, o, u = 0;
			for (var a = 0, f = l.shapeList.length; a < f; a++) l.shapeList[a]._main && (o = c[l.shapeList[a]._seriesIndex], u += 1, n = l.shapeList[a].style.pointList[0][0], r = l.shapeList[a].style.pointList[0][1], l.shapeList[a]._orient == "horizontal" ? i.modShape(l.shapeList[a].id, {
				scale: [0, 1, n, r]
	...
	function n(t, n) {
		...
		if (a.match("star")) u = a.replace("star", "") - 0 || 5, i -= 1, a = "star";
		else if (a == "rectangle" || a == "arrow") r += (s - o) / 2, s = o;
		var f = "";
	...
	function t(t, n, r, i, s) {
		...
		function g(e, n, r) {
			...
			for (var B = 0, j = n.length; B < j; B++)
				for (var F = 0, I = n[B].length; F < I; F++) o = n[B][F], T[o].counter > 0 && (T[o].average = (T[o].sum / T[o].counter).toFixed(2) - 0), C = s.yAxis.getAxis(c[o].yAxisIndex || 0).getCoord(T[o].average), T[o].averageLine = [
					[s.grid.getX(), C],
					[s.grid.getXend(), C]
				], T[o].minLine = [
					[s.grid.getX(), T[o].minY],
					[s.grid.getXend(), T[o].minY]
				], T[o].maxLine = [
		...
		function y(e, n, r) {
			...
			for (var B = 0, j = n.length; B < j; B++)
				for (var F = 0, I = n[B].length; F < I; F++) o = n[B][F], T[o].counter > 0 && (T[o].average = (T[o].sum / T[o].counter).toFixed(2) - 0), N = s.xAxis.getAxis(c[o].xAxisIndex || 0).getCoord(T[o].average), T[o].averageLine = [
					[N, s.grid.getYend()],
					[N, s.grid.getY()]
				], T[o].minLine = [
					[T[o].minX, s.grid.getYend()],
					[T[o].minX, s.grid.getY()]
				], T[o].maxLine = [
		...
		function b(e, t, n) {
			...
			if (t.length != o)
				...
				} else S = e.getGap(), a = 0, x = Math.floor(S / t.length), x <= 0 && (x = 1);
			else {
		...
		function E(e, t, n) {
			for (var r = 0, i = e.length; r < i; r++) l.buildMark(c[e[r]], e[r], s, {
				isHorizontal: n,
				xMarkMap: t
			})
		}
		...
		function N(e) {
			...
			for (var n = l.shapeList.length - 1; n >= 0; n--) {
				...
				if (t[d] && !t[d][3] && l.shapeList[n].shape == "rectangle") {
					...
					l.shapeList[n]._orient == "horizontal" ? (h = s.yAxis.getAxis(p.yAxisIndex || 0).getGap(), f = t[d][2] ? -h : h, o = 0) : (u = s.xAxis.getAxis(p.xAxisIndex || 0).getGap(), o = t[d][2] ? u : -u, f = 0), r.animate(l.shapeList[n].id, "").when(500, {
						position: [o, f]
					}).start()
				}
			}
	...
	function t(t, n, r, i, s) {
		...
		function E(e, t, n, i, s, o, u, a) {
			...
			var m = a ? "emphasis" : "normal",
				g = l.merge(l.clone(v.itemStyle) || {}, c.itemStyle, {
					overwrite: !1,
					recursive: !0
				}),
				y = g[m].label,
		...
		function x(e, t, n, i, s, o, u, a, c) {
			...
			if (N(v, m, c)) {
				var g = c ? "emphasis" : "normal",
					y = l.merge(l.clone(m.itemStyle) || {}, v.itemStyle, {
						overwrite: !1,
						recursive: !0
					}),
					b = y[g].labelLine,
			...
			for (var i = 0, s = f.length; i < s; i++) {
				...
				if (n[c]) {
					...
					if (f[i].shape == "sector") w != "delete" ? r.animate(f[i].id, "style").when(400, {
						...
						if (w == "delete") r.delShape(f[i].id);
						else switch (f[i].shape) {
							case "text":
								w = u[b], r.animate(f[i].id, "style").when(400, {
									x: w.style.x,
									y: w.style.y
								}).start();
								break;
		...
		function _(t, n) {
			...
			if (f == -1) l = {
				value: a.get(o, "value"),
				name: a.get(o, "name")
			}, l.value < 0 && (l.value = 0), p[u].data.push(l), c && c.add(l.name, o.style.color || o.style.strokeColor);
			else {
